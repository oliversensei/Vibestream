...
const VibeStreamLogo = () => (
  ...
  >
    ...
    <path d="M12 0c-6.628 0-12 5.372-12 12s5.372 12 12 12 12-5.372 12-12-5.372-12-12-12zm0 21.6c-5.302 0-9.6-4.298-9.6-9.6s4.298-9.6 9.6-9.6 9.6 4.298 9.6 9.6-4.298 9.6-9.6 9.6zm-3.6-13.2c.497 0 .9.403.9.9v4.8c0 .497-.403.9-.9.9s-.9-.403-.9-.9v-4.8c0-.497.403-.9.9-.9zm3.6 1.8c.497 0 .9.403.9.9v3c0 .497-.403.9-.9.9s-.9-.403-.9-.9v-3c0-.497.403-.9.9-.9zm3.6-1.8c.497 0 .9.403.9.9v4.8c0 .497-.403.9-.9.9s-.9-.403-.9-.9v-4.8c0-.497.403-.9.9-.9z" />
  </svg>
);
